...
const features = [
	{
		...
		title: "CLI First",
		description: "8 commands. Every command supports --json for scripting and AI agent pipelines.",
	},
	{
		icon: (
			<svg
	...
	},
	{
		...
		description: "Append-only local files. No database. Grep-able, portable, version-controllable.",
	},
];
...
const steps = [
	...
	},
	{
		step: "03",
		title: "Sync",
		description: "Attach entries to git commits and push them to ClickUp with a single command.",
	},
];
			...
			<main className="flex flex-col">
				...
				<section className="relative flex flex-col items-center justify-center gap-6 overflow-hidden px-4 py-28 text-center">
					...
					<h1 className="max-w-3xl text-balance text-5xl font-bold tracking-tight sm:text-6xl">
						Capture work. <span className="text-fd-primary">Consolidate.</span> Sync.
					</h1>
					<p className="max-w-xl text-balance text-lg text-fd-muted-foreground">
						TaskTrace sits between your git workflow and your task manager. Capture what you
						actually did, let AI agents consolidate messy notes into clean entries, and sync the
						result to ClickUp.
					</p>
					...
					<div className="mx-auto max-w-4xl">
						...
						<div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
							{steps.map((s) => (
								...
								>
									<span className="text-5xl font-bold text-fd-primary/20">{s.step}</span>
					...
					<div className="mx-auto max-w-xl">
						...
						<div className="mt-8 overflow-hidden rounded-lg border border-fd-border bg-fd-card">
							...
							<div className="px-5 py-3 text-left">
								<code className="text-sm text-fd-foreground">bun add -g @tasktrace/cli</code>
							</div>
						</div>
